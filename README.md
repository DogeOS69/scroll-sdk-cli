...
FLAGS
  ...
  --enable-withdrawal-proof               Set withdrawalProof.enabled=true after staging and atomically project the
                                          explicit runtime env; without this flag the activation state is preserved
                                          as-is
  --json                                  Output structured JSON
