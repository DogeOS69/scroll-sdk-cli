...
export const contracts: DeployedContract[] = [
  ...
  {name: 'L2_WDOGE_ADDR', initializes: false, owned: false, layer: Layer.L2},
  ...
  {name: 'L2_DOGEOS_MESSENGER_PROXY_ADDR', initializes: true, owned: true, layer: Layer.L2},
  ...
  {name: 'L1_MESSAGE_QUEUE_V2_PROXY_ADDR', initializes: true, owned: true, layer: Layer.L1},
  {name: 'L2_DOGEOS_MESSENGER_IMPLEMENTATION_ADDR', initializes: false, owned: false, layer: Layer.L2},
  ...
  {name: 'L2_MOAT_IMPLEMENTATION_ADDR', initializes: false, owned: false, layer: Layer.L2},
  {name: 'L2_MOAT_PROXY_ADDR', initializes: true, owned: true, layer: Layer.L2},
  {name: 'L2_BASCULE_MOCK_VERIFIER_ADDR', initializes: false, owned: false, layer: Layer.L2},
...
//     { name: "L2_DOGEOS_MESSENGER_IMPLEMENTATION_ADDR", initializes: false, owned: false },
//     { name: "L2_DOGEOS_MESSENGER_PROXY_ADDR", initializes: true, owned: true },
